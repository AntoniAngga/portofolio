  ...
  return (
    <Fragment>
      ...
      <div className="about_text w-full h-auto clear-both float-left border-solid border-[#DFDFDF] border-b pb-[31px] mb-[30px]">
        <p className="mb-[11px]">
          Hi, my name is Antoni Angga and I began using NodeJs when it first
          began. I’ve spent most of my waking hours for the last ten years
          designing, programming and operating NodeJs sites.
        </p>
        <p>
          ...
          <div className="tokyo_tm_info w-full h-auto clear-both float-left">
            <ul className="m-0 list-none">
              ...
              <li className="m-0">
                ...
                <span>{getAge("1995-04-15T00:00:00Z")}</span>
              </li>
              <li className="m-0">
                <span className="min-w-[100px] float-left mr-[10px] font-bold text-black">
                  Address:
              ...
              <li className="m-0">
                ...
                <span>
                  <a
                    ...
                    href="mailto:antoniangga14@gmail.com"
                  >
                    antoniangga14@gmail.com
                  </a>
                </span>
              </li>
              <li className="m-0">
      ...
      <div className="tokyo_tm_button" data-position="left">
        <a href="assets/img/cv/antoniangga.pdf" download>
