...
const socialIcon = [
  {
    ...
    link: "https://www.facebook.com/antoni.angga",
  },
  {
    id: 2,
    iconName: "icon-github-squared",
    link: "https://github.com/AntoniAngga",
  },
  {
    id: 3,
    iconName: "icon-linkedin-squared",
    link: "https://www.linkedin.com/in/antoni-angga-83442491/",
  },
];
const Home = () => {
  return (
          ...
          <div className="home_content flex items-center">
            ...
            >
              ...
              <div
                ...
                data-img-url="assets/img/profile-picture.jpg"
              />

            </div>
            <div className="details ml-[80px]">
              <h3 className="name text-[55px] font-extrabold uppercase mb-[14px]">
                Antoni <span>Angga</span>
              </h3>
